...
ActiveRecord::Schema.define(version: 2018_07_16_160310) do
  ...
  create_table "assets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.decimal "reported_condition_rating", precision: 9, scale: 1
    ...
    t.decimal "estimated_condition_rating", precision: 9, scale: 1
    t.integer "service_status_type_id"
    ...
    t.integer "rebuild_year"
    t.string "license_plate", limit: 12
    ...
    t.integer "sign_standard_id"
    t.integer "sheeting_type_id"
    t.integer "blank_type_id"
    t.integer "sign_legend_color_type_id"
    t.integer "sign_background_color_type_id"
    t.integer "arrow_direction_type_id"
    t.date "last_refaced_on_date"
    t.integer "support_condition_type_id"
    t.date "support_in_service_date"
    t.integer "support_type_id"
    t.integer "support_size_type_id"
    t.integer "support_shared_idx"
    t.integer "travel_direction_type_id"
    t.integer "facing_direction_type_id"
    t.integer "side_of_road_type_id"
    t.integer "direction_from_intersection_type_id"
    t.integer "distance_from_intersection"
    t.integer "lateral_offset"
    t.decimal "latitude", precision: 11, scale: 6
    t.decimal "longitude", precision: 11, scale: 6
    t.string "street_name", limit: 64
    t.boolean "georectified"
  ...
  create_table "assets_vehicle_features", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "asset_id", null: false
    t.integer "vehicle_feature_id", null: false
    t.index ["asset_id", "vehicle_feature_id"], name: "assets_vehicle_features_idx1"
  end

  create_table "blank_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false
    t.string "description", limit: 254, null: false
    t.boolean "active", null: false
  end

  create_table "color_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false
    t.boolean "legend", null: false
  ...
  create_table "crew_members", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "asset_id", null: false
    t.integer "user_id", null: false
    t.boolean "supervisor", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["asset_id", "user_id"], name: "crew_members_idx1"
    t.index ["supervisor"], name: "crew_members_idx2"
  end
  ...
  create_table "direction_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false
  ...
  create_table "sheeting_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false
    t.string "code", limit: 4, null: false
    t.string "description", limit: 254, null: false
    t.integer "max_service_life", null: false
    t.boolean "active", null: false
  end

  create_table "side_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false
    t.string "code", limit: 2, null: false
    t.string "description", limit: 254, null: false
    t.boolean "active", null: false
  ...
  create_table "sign_standard_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "asset_subtype_id", null: false
    t.string "name", limit: 64, null: false
    t.string "description", limit: 254, null: false
    t.boolean "active", null: false
    t.index ["asset_subtype_id"], name: "sign_standard_types_idx1"
  end

  create_table "sign_standards", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "object_key", limit: 12, null: false
    t.string "external_id", limit: 32
    t.integer "sign_standard_type_id", null: false
    t.integer "asset_subtype_id", null: false
    t.string "smo_code", limit: 16, null: false
    t.string "size_description", limit: 16, null: false
    t.string "sign_description", limit: 254, null: false
    t.string "imagepath", limit: 254
    t.integer "superseded_by_id"
    t.date "superseded_date"
    t.date "voided_on_date"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["asset_subtype_id"], name: "sign_standards_idx3"
    t.index ["object_key"], name: "sign_standards_idx1"
    t.index ["sign_description"], name: "sign_standards_idx4"
    t.index ["sign_standard_type_id"], name: "sign_standards_idx5"
    t.index ["smo_code"], name: "index_sign_standards_on_smo_code", unique: true
    t.index ["smo_code"], name: "sign_standards_idx2"
  end

  create_table "support_size_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false
    t.string "description", limit: 254, null: false
    t.boolean "active", default: true, null: false
  end

  create_table "support_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false
    t.string "description", limit: 254, null: false
    t.boolean "active", default: true, null: false
    t.boolean "fixed_support"
  end
  ...
  create_table "time_of_day_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 64, null: false
    t.string "description", limit: 254, null: false
    t.boolean "active", default: true, null: false
  end
