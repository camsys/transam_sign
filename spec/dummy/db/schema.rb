...
ActiveRecord::Schema.define(version: 20160531152346) do
  ...
  create_table "assets", force: true do |t|
    ...
    t.string   "location_comments",                   limit: 254
  ...
  add_index "crew_members", ["asset_id", "user_id"], name: "crew_members_idx1", using: :btree
  add_index "crew_members", ["supervisor"], name: "crew_members_idx2", using: :btree
  ...
  create_table "direction_types", force: true do |t|
    t.string  "name",        limit: 64,  null: false
  ...
  create_table "sheeting_types", force: true do |t|
    t.string  "name",             limit: 64,  null: false
    t.string  "code",             limit: 4,   null: false
    t.string  "description",      limit: 254, null: false
  ...
  create_table "sign_standard_types", force: true do |t|
    t.integer "asset_subtype_id",             null: false
    t.string  "name",             limit: 64,  null: false
    t.string  "description",      limit: 254, null: false
    t.boolean "active",                       null: false
  ...
  add_index "sign_standard_types", ["asset_subtype_id"], name: "sign_standard_types_idx1", using: :btree

  create_table "sign_standards", force: true do |t|
    t.string   "object_key",            limit: 12,  null: false
    t.string   "external_id",           limit: 32
  ...
  add_index "sign_standards", ["asset_subtype_id"], name: "sign_standards_idx3", using: :btree
  ...
  create_table "time_of_day_types", force: true do |t|
    t.string  "name",        limit: 64,                 null: false
    t.string  "description", limit: 254,                null: false
    t.boolean "active",                  default: true, null: false
  end
